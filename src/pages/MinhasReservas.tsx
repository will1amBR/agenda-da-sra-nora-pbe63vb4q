    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-10 text-left">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-slate-600">
          ...
          <code className="bg-teal-50 border border-teal-200 px-1 py-0.5 rounded text-xs font-mono font-bold text-teal-800">
            NORA-2025-018
          </code>
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-teal-700 hover:bg-teal-800 text-white px-6 font-medium"
          >
            Buscar Reserva
          </Button>
        </form>
      ...
      <div className="space-y-6">
        ...
        {results.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 space-y-3">
            ...
            <p className="text-sm font-semibold text-slate-900">Nenhuma reserva encontrada</p>
            ...
            <Button
              asChild
              className="bg-teal-700 hover:bg-teal-800 text-white rounded-full text-xs mt-2"
            >
          ...
          <div className="space-y-4">
            {results.map((booking) => {
              ...
              return (
                <Card
                  key={booking.id}
                  className="border-slate-200 bg-white rounded-2xl shadow-xs overflow-hidden"
                >
                  <CardContent className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-700">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-slate-600">Tel: {booking.client.phone}</p>
                      </div>
                    ...
                    {booking.status === 'aguardando_aprovacao' && (
                      <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-xs text-slate-600 flex items-center justify-between">
                        ...
                        <Link
                          ...
                          className="text-teal-700 font-medium hover:underline text-[11px] shrink-0"
                        >
                          Simular como Nora →
                        </Link>
                      </div>
